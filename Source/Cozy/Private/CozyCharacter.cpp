...
void ACozyCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ACozyCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ACozyCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACozyCharacter::OnResetVR);
}


void ACozyCharacter::OnResetVR()
{
	// If Cozy is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Cozy.Build.cs is not automatically propagated
...
void ACozyCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ACozyCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
